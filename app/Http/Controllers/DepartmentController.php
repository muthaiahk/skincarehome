...
class DepartmentController extends BaseController
{
    public function Index(){
        ...
        $department = Department::select('department_id','department_name','dept_incharge','company.company_id','company.company_name','branch.branch_id','branch.branch_name','department.status')                       
        ->join('company', 'company.company_id','=','department.company_id')
        ->join('branch', 'branch.branch_id','=','department.branch_id')
        //->join('staff', 'staff.staff_id','=','department.dept_incharge')
    ...
    public function Edit($id){
        $department = Department::select('department.department_id','department.department_name','department.dept_incharge','company.company_id','company.company_name','branch.branch_id','branch.branch_name','department.status') 
                        ->join('company', 'company.company_id','=','department.company_id')
                        ->join('branch', 'branch.branch_id','=','department.branch_id')
                        // ->join('staff', 'staff.staff_id','=','department.dept_incharge')
    ...
    public function Delete($id){
        $status = Department::where('department_id', $id)->first();
