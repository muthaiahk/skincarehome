...
class DesignationController extends BaseController
{
    ...
    public function Status(Request $request, $id){
        ...
        $designation_status = Designation::where('job_id', $id)->first();

        if($designation_status){
            $designation_status->status = $request->status;
            $designation_status->status = $request->user()->id;
            
            $designation_status->update();
        }else{
            return response([
                'data' => null,
