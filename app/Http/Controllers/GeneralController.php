...
class GeneralController extends BaseController
{
    ...
    public function Update(Request $request,$id){
        ...
        if($validator->fails()) {
            ...
            $established_date = $request->opening_date;
            $company_address  = "";
            $contact_person   = "";
            ...
            $general   =  General::where('g_set_id',$id)->first();
            ...
            if($general){
               // return $request->logo;
                ...
                if($request->logo) { 
                    ...
                    $logo = "https://crm.renewhairandskincare.com/renew_api/public/".$destinationPath ."/".$imageName;
                ...
                if($request->favicon) { 
                    ...
                    $request->favicon->move(public_path($destinationPath), $imageName);

                    $favicon = "https://crm.renewhairandskincare.com/renew_api/public/".$destinationPath ."/".$imageName;
                ...
                if ($request->default_pic) { 
                    ...
                    // //  $myimage = $request->favicon->getClientOriginalName();
                    $request->default_pic->move(public_path($destinationPath), $imageName);
                    $default_pic = "https://crm.renewhairandskincare.com/renew_api/public/".$destinationPath ."/".$imageName;
            ...
            //     //$general->modified_dt      = date('Y-mm-dd H:s:m');
                ...
                if($general){
                    ...
                    $company_upd = Company::where('company_id',1)->first();
                    $company_upd->company_name = $company_name;
                    $company_upd->update();
